...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['tab_safety'] = $this->language->get('tab_safety');
			...
			$this->data['activity'] = html_entity_decode($product_info['activity'], ENT_QUOTES, 'UTF-8');
			$this->data['safety'] = html_entity_decode($product_info['safety'], ENT_QUOTES, 'UTF-8');
			$this->data['prices'] = html_entity_decode($product_info['prices'], ENT_QUOTES, 'UTF-8');
