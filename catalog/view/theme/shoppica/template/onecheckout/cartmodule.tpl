...
<div class="cart-module">
  ...
  <div class="cart-content" id="coupon"><?php echo $entry_coupon; ?>&nbsp;<br />
    ...
    &nbsp;<a id="button-coupon" class="onebutton"><span><?php echo $button_coupon; ?></span></a></div>
</div>
<?php } ?>
...
<div class="cart-module">
  ...
  &nbsp;<a id="button-reward" class="onebutton"><span><?php echo $button_reward; ?></span></a></div>
</div>
<?php } ?>
...
<div class="cart-module">
  ...
  <div class="cart-content" id="voucher"><?php echo $entry_voucher; ?>&nbsp;<br />
    ...
    &nbsp;<a id="button-voucher" class="onebutton"><span><?php echo $button_voucher; ?></span></a></div>
</div>
<?php } ?>
<style type="text/css">
.cart-module > div {
...
.cart-module .cart-heading {
	...
	margin-bottom: 15px;
	cursor: pointer;
	background: #F8F8F8 url('catalog/view/theme/shoppica/image/arrow-right.png') 10px 50% no-repeat;
}
.cart-module .active {
	background: #F8F8F8 url('catalog/view/theme/shoppica/image/arrow-down.png') 7px 50% no-repeat;
}
