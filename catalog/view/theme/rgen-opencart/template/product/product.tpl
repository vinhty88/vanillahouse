			...
			<div class="right prdoptions-wrapper">
				...
				<div class="l">
					...
					<dl class="description">
						<?php if ($manufacturer) { ?>
						<dt><span><?php echo $text_manufacturer; ?></span></dt><dd><a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></dd>
						<?php } ?>
						...
						<?php } ?>
						<?php if ($material) { ?>
				        <dt><span><?php echo $text_material; ?></span></dt><dd><?php echo $material; ?></dd>
				        <?php } ?>
				        <?php if ($size) { ?>
				        <dt><span><?php echo $text_size; ?></span></dt><dd><?php echo $size; ?></dd>
				        <?php } ?>
					...
					<div>
						<!--<p class="contact_product"><span style="width: 35px;height: 35px;display: inline-block;" class="ph-image" title="Phone"></span><strong>Đặt hàng qua điện thoại:</strong><br /> 0946433033</p>-->
						<p class="contact_product"><strong>Đặt hàng qua điện thoại:</strong><br /> 0946433033</p>
					</div>
				</div>
