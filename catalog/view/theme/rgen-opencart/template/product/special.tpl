			...
			<div class="prd-block">
				...
				<div class="info-wrp">
					<div class="info">
						...
						<span class="cart-button"><a class="cart-bt" title="<?php echo $this->language->get('button_cart'); ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></a></span>
						<ul>
