	...
	<div class="content">
		...
		<div class="mini-cart-info">
			<table>
				...
				<tr>
					<td class="image"><span><img src="catalog/view/theme/rgen-opencart/image/rgen/giftcard.png" alt="<?php echo $vouchers['description']; ?>" title="<?php echo $vouchers['description']; ?>" /></span></td>
