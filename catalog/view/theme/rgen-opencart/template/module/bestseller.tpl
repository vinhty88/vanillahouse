...
<div class="box bestseller-prd" id="bestseller-prd<?php echo $module; ?>">
	<div class="box-heading header-1"><?php echo $heading_title; ?></div>
	<?php if($this->config->get('RGen_colprdView_best') != 'scroll'){ ?>
	...
	<script type="text/javascript">
		$('#bestseller-prd<?php echo $module; ?>').find('.box-product').carouFredSel({
...
if ($this->config->get('RGen_SlideShow_Mod_status') == 1 && $this->config->get('RGen_SlideShow_Mod') == 'best' && $getRoute == 'common/home') { ?>
<div class="box bestseller-prd slidshow-prd list-carousel" id="slidshow-box">
<?php }else { ?>
<div class="box bestseller-prd list-carousel<?php if ($this->config->get('RGen_carouselArrow') == 'tr') { ?> arrow-tr<?php } ?>" id="bestseller-prd<?php echo $module; ?>">
<?php } ?>
