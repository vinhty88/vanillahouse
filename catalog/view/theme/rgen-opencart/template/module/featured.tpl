...
<div class="box featured-box" id="featured-box<?php echo $module; ?>">
	...
	<?php if($this->config->get('RGen_colprdView_featured') != 'scroll'){ ?>
	...
	<script type="text/javascript">
		$('#featured-box<?php echo $module; ?>').find('.box-product').carouFredSel({
			prev: '#featured-box<?php echo $module; ?> .carousel-controls .prev',
			next: '#featured-box<?php echo $module; ?> .carousel-controls .next',
			scroll: 1,
			width:'100%',
			swipe:{onTouch: true},
			auto: false,
...
if ($this->config->get('RGen_SlideShow_Mod_status') == 1 && $this->config->get('RGen_SlideShow_Mod') == 'featured' && $getRoute == 'common/home') { ?>
<div class="box featured-box slidshow-prd list-carousel" id="slidshow-box">
<?php }else { ?>
<div class="box featured-box list-carousel<?php if ($this->config->get('RGen_carouselArrow') == 'tr') { ?> arrow-tr<?php } ?>" id="featured-box<?php echo $module; ?>">
<?php } ?>
...
$(document).ready(function(){
	...
	*******************************************/
	<?php if ($this->config->get('RGen_SlideShow_Mod_status') == 1 && $this->config->get('RGen_SlideShow_Mod') == 'featured' && $getRoute == 'common/home') { ?>
