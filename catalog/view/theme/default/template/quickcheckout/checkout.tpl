...
<script type="text/javascript">
	var textCheckout = "Chúng tôi sẽ liên hệ Quý Khách sau khi đã nhận được hóa đơn";
</script>
...
function reloadPaymentMethod(country_id, zone_id, isset, city, postcode) {
	$.ajax({
		...
		success: function(html) {
			//$('#payment-method .quickcheckout-content').html(textCheckout);
			//$('#payment-method .quickcheckout-content').html(html);
			var textPay = textCheckout + "<input type='hidden' name='payment_method' value='cod' />";
			$('#payment-method .quickcheckout-content').html(textPay);	
...
function validatePaymentMethod() {
	$.ajax({
		...
		type: 'post',
		data: $('#payment-method input[type=\'hidden\'], #payment-method select, #payment-method input[type=\'radio\']:checked, #payment-method input[type=\'checkbox\']:checked, #payment-method textarea'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-payment-method').attr('disabled', true);
			$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/default/image/loading.gif" alt="" /></span>');
...
<?php if ($shipping_required) { ?>
	function reloadShippingMethod(country_id, zone_id, isset, city, postcode) {
		$.ajax({
			...
			success: function(html) {
				...
				var textShip = textCheckout + "<input type='hidden' name='shipping_method' value='flat.flat' />";
				$('#shipping-method .quickcheckout-content').html(textShip);
	...
	function validateShippingMethod() {
		$.ajax({
			...
			type: 'post',
			data: $('#shipping-method input[type=\'hidden\'], #shipping-method select, #shipping-method input[type=\'radio\']:checked, #shipping-method textarea'),
			dataType: 'json',
			beforeSend: function() {
				$('#button-payment-method').attr('disabled', true);
				$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/default/image/loading.gif" alt="" /></span>');
